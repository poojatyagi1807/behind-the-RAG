...
def render():
    ...
    rows_data = [
        (
            ...
            "We default to Top 10 and let users adjust via a slider. We never validated what K produces the best faithfulness scores on our query types — the default is intuition, not measurement.",
        ...
        (
            ...
            "We show a warning at score below 0.25 but still pass low-confidence chunks to the LLM. We chose 0.25 without calibrating against human judgement of what makes an answer trustworthy.",
        ...
        (
            ...
            "We built hybrid search (dense + BM25 via RRF) from the start without measuring whether it improves over dense-only on our specific KB. We assumed hybrid was better and shipped it as the default.",
        ...
        (
            ...
            "We always return something — even low-confidence results. Users see a warning but still get an LLM answer built on weak evidence. We never defined a hard cutoff where we'd say 'I don't know' instead.",
        ...
        (
            ...
            "We used HNSW default settings without tuning for our scale. At 312 chunks, brute-force search would be equally fast — we added HNSW complexity without validating it provides any retrieval benefit at this size.",
