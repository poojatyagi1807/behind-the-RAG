...
def render():
    ...
    rows_data = [
        (
            ...
            "We provide 9 recommended questions designed by the builder, with no user research to validate them. They reflect what we assumed non-technical PMs would ask — not what they actually ask.",
        ...
        (
            ...
            "We show 9 suggested queries with no analytics on which ones users click. We have zero signal on what learners are actually trying to understand when they open the app.",
        ...
        (
            ...
            "We set no query length limit. A user can paste a 2000-word document — HyDE will try to generate a hypothetical answer for it, produce garbage, and retrieval will break silently with no explanation.",
        ...
        (
            ...
            "HyDE generates a hypothetical answer and searches on that. For an ambiguous query like 'how does it work?', it invents a plausible-sounding hypothesis and retrieves confidently in the wrong direction — with no clarifying fallback.",
        ...
        (
            ...
            "We went all-in on free-form queries with HyDE and offer no structured alternative. Some questions — like 'show me what happens at Step 9' — would be better served by direct navigation than by retrieval.",
        ...
        (
            ...
            "HyDE expands every query aggressively into a hypothetical answer before searching. We never validated whether that expansion stays within RAG topics or drifts into adjacent AI concepts — no scope audit was done.",
        ...
        (
            ...
            "We log nothing. We can't see whether query patterns change over time or whether certain topics consistently fail to retrieve useful answers — that signal is completely invisible.",
        ...
        (
            ...
            "We show a spinner during retrieval with no message. A 2-3 second wait with no explanation gives the user no indication of what's happening — and misses a teaching moment about what retrieval actually does.",
        ...
        (
            ...
            "Out-of-scope queries return low-confidence results with a warning banner, but the chunks are still passed to the LLM. We never defined a hard threshold where the system would say 'I don't know' instead of guessing.",
        ...
        (
            ...
            "We shipped query guardrails in the system prompt without red-teaming them. We never ran a single adversarial test case to verify the guardrails hold when a user pushes the app off-topic.",
