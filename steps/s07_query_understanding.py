...
def render():
    ...
    rows_data = [
        (
            ...
            "We support free-form queries and provide 9 recommended questions. But we never validated which queries our target users (non-technical PMs) actually ask. We designed the examples from the builder's perspective, not from user research.",
        ...
        (
            ...
            "We have 9 suggested queries but no analytics to see which ones users actually click. A PM should have instrumented query selection from launch — knowing which questions users start with tells you what they're actually trying to learn.",
        ...
        (
            ...
            "No query length limit. A user could paste a 2000-word document. HyDE would try to generate a hypothetical answer for it, fail or produce garbage, and retrieval would break silently. A PM should have defined a maximum query length and a clear error message.",
        ...
        (
            ...
            "HyDE generates a hypothetical answer and searches on that. But if the query is ambiguous ('how does it work?'), HyDE invents a plausible-sounding but wrong hypothesis. We have no fallback to ask a clarifying question when intent is unclear.",
        ...
        (
            ...
            "We went all-in on free-form queries with HyDE. There's no structured option. A PM should have asked: are there queries where structured step filters would outperform AI query understanding? For this app, step-specific questions might benefit from a direct navigation option.",
        ...
        (
            ...
            "HyDE expands the query aggressively. For this app — which is scoped to RAG topics only — we never validated whether HyDE expansion stays within scope or drifts into unrelated AI concepts. No guardrail audit was done before launch.",
        ...
        (
            ...
            "No query logging. We can't see whether query patterns are changing over time or whether certain topics are consistently unanswered. A PM should have planned query telemetry from day one — even anonymised intent logging would show us where the KB is failing.",
        ...
        (
            ...
            "We show a spinner during retrieval with no explanation. A PM should have defined what to show during the 2-3 second wait: a progress message that explains what the system is doing ('Searching 312 chunks...') builds trust and teaches the user at the same time.",
        ...
        (
            ...
            "Out-of-scope queries return low-confidence results with a warning. But we never defined what 'out of scope' means for this app. A PM should have written a scope document: what RAG topics are in scope, what's out, and what the fallback message should say.",
        ...
        (
            ...
            "No prompt injection testing. We shipped query guardrails without running adversarial test cases. A PM should have run 10 jailbreak attempts before launch to verify the system prompt holds.",
