...
Only feasible for top-K.""", language=None)
    ...
    rows_data = [
        (
            ...
            "We added Cohere re-ranking without first measuring whether retrieval quality was already good enough. We built a solution to a problem we never confirmed existed.",
        ...
        (
            ...
            "We use Cohere's default relevance scoring without questioning it. For a learning app, 'best chunk' might mean most complete explanation — but we never asked whether pedagogical completeness should be a re-ranking signal.",
        ...
        (
            ...
            "We use Cohere's cross-encoder which adds ~500ms latency. We never tested whether that delay is acceptable to a learner expecting an instant response — or whether the quality gain justifies the cost.",
        ...
        (
            ...
            "We pass Top 10 to Cohere and keep the top 3-5 — a cutoff chosen by intuition, never validated. We don't know whether the 6th-ranked chunk after re-ranking often contains the most useful context.",
        ...
        (
            ...
            "We never audited Cohere's re-ranker for content bias. If it systematically favours blog-style content over academic papers, the educational balance of our answers shifts — and we have no way to detect it.",
