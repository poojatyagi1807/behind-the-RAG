...
Only feasible for top-K.""", language=None)
    ...
    rows_data = [
        (
            ...
            "We integrated Cohere re-ranking as an optional step but never measured whether it improves answer quality on our KB. A PM should have run: take 20 questions, compare faithfulness with and without re-ranking. We assumed it helps without measuring.",
        ...
        (
            ...
            "We use Cohere's default relevance scoring. For our educational use case, a 'best chunk' might be one with the most complete explanation — not just the most semantically similar. We never asked: should pedagogical completeness be a re-ranking signal?",
        ...
        (
            ...
            "Cohere re-ranking adds ~500ms latency. For a learning app where users expect instant responses, we never asked whether that latency is acceptable. A PM should have tested: does the quality improvement justify the delay for our specific use case?",
        ...
        (
            ...
            "We pass Top 10 to Cohere and take the top 3-5 after re-ranking. We never validated this cutoff. If the 6th chunk often contains critical context, we're losing it. A PM should define the cutoff based on measured answer quality, not intuition.",
        ...
        (
            ...
            "Unknown. Cohere's re-ranker is a black box. If it systematically downranks chunks from academic papers in favour of blog-style content, our educational balance gets skewed. A PM should check: does re-ranking change which of our 5 source documents dominate the top results?",
