...
def render():
    ...
    rows_data = [
        (
            ...
            "We define grounding as word-overlap between answer sentences and retrieved chunks. This flags accurate paraphrases as ungrounded — we built the checker before defining what 'grounded' actually means to a human reader.",
        ...
        (
            ...
            "Grounding is evaluated automatically with no human review. We never validated whether our word-overlap definition matches what a non-technical PM would consider a trustworthy, sourced answer.",
        ...
        (
            ...
            "We show a warning at grounding below 60% — chosen without any calibration. We don't know whether 60% corresponds to answers that actually mislead users, or whether that threshold is too loose or too strict.",
        ...
        (
            ...
            "We show per-sentence grounding scores but still display the full answer. A sentence flagged as ungrounded sits next to grounded ones with no visual distinction — users can't tell which parts to treat with caution.",
        ...
        (
            ...
            "We run grounding on every response. For a production version this adds latency with no defined tradeoff — we never decided whether per-response grounding is essential or whether periodic sampling would be sufficient.",
