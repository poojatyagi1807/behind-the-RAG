  ...
  "indexed_at": "2024-05-01T09:23:41Z"
    ...
    render_pm_matrix("Document Ingestion + Parsing", [
        (
            ...
            "We picked 5 documents informally — no inclusion criteria defined. A RAG paper from 2020, a blog post, framework docs. We never asked: what's the minimum recency for a fast-moving field? We included a 2020 paper when the field looked very different by 2024.",
        ...
        (
            ...
            "The Lewis et al. RAG paper in our KB is from 2020. RAG evolved significantly from 2022–2024. A PM should have set a freshness rule: no source older than 2 years for a fast-moving field. We didn't — so users may learn outdated patterns.",
        ...
        (
            ...
            "This app has no auth — everyone sees everything. Fine for a public learning tool. But we never made that decision explicitly. A PM should document: is this intentionally public? What if a company wants to use it with proprietary content? No ACL plan means retrofitting later.",
        ...
        (
            ...
            "We accepted all 5 documents at face value. No readability check, no minimum depth requirement. The Lilian Weng blog has very different depth than the RAG paper. A PM should have set a quality bar: each document must cover at least 3 core RAG concepts at explanatory depth.",
        ...
        (
            ...
            "No maintenance plan exists. If LangChain releases a major update or RAGAS adds new metrics, the KB becomes stale with no one responsible for updating it. A PM should have assigned an owner and a review cadence — even for a demo app.",
