  ...
  "indexed_at": "2024-05-01T09:23:41Z"
    ...
    render_pm_matrix("Document Ingestion + Parsing", [
        (
            ...
            "Legal team ingests expired contracts — model cites outdated clauses in customer responses.",
        ...
        (
            ...
            "Support bot answers with a return policy changed 3 months ago — customer escalates.",
        ...
        (
            ...
            "Sales rep surfaces confidential pricing data meant only for the finance team.",
        ...
        (
            ...
            "A 2019 Confluence page becomes the top result for a current product question.",
        ...
        (
            ...
            "SharePoint folder not updated for a quarter — users blame the AI, not the stale content.",
