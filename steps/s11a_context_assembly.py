...
""", unsafe_allow_html=True)
    ...
    rows_data = [
        (
            ...
            "We wrote a system prompt and shipped it without user-testing the output. We don't know whether the grounding instruction makes answers sound robotic or overly hedged to a non-technical PM reader.",
        ...
        (
            ...
            "We allocate 6,000 tokens for context but never measured whether we actually hit that limit. We have no telemetry — silent truncation may be happening in longer sessions and we'd never know.",
        ...
        (
            ...
            "We wrote guardrails into the system prompt and shipped them without adversarial testing. We never confirmed the guardrails hold when a user actively tries to push the app off-topic.",
        ...
        (
            ...
            "Each query is independent — we carry no conversation history. This limitation was never surfaced to the user, so learners who expect the app to remember their previous question get confused with no explanation.",
        ...
        (
            ...
            "The system prompt was written by the builder, hardcoded, and never reviewed. There's no version history, no documented rationale — it could be quietly changed at any time with no audit trail.",
