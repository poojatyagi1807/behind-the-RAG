...
""", unsafe_allow_html=True)
    ...
    rows_data = [
        (
            ...
            "Customer-facing legal assistant shows document name, publication date, and law firm — users verify before acting.",
        ...
        (
            ...
            "E-commerce support adds product_category — queries filtered to matching product only, eliminating cross-category noise.",
        ...
        (
            ...
            "Large enterprise uses an LLM pipeline to classify doc type and extract named entities at ingest — zero manual labeling.",
        ...
        (
            ...
            "Policy update triggers full re-ingestion: new vector, new metadata, refreshed timestamp — always together.",
        ...
        (
            ...
            "Enterprise search shows doc title, section, department, and last-updated date in each result card — users decide before clicking.",
