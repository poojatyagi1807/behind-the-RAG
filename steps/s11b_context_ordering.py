...
def render():
    ...
    rows_data = [
        (
            ...
            "We implemented sandwich ordering — best chunk first, second-best last, rest in middle. But we never measured whether it actually improves answer quality on our educational queries. We applied the research finding without validating it on our specific content type.",
        ...
        (
            ...
            "We put the highest-scored chunk first. But for educational content, the 'best' chunk might be the one with the most complete concept explanation, not the highest similarity score. We never asked whether score rank equals pedagogical value for our use case.",
        ...
        (
            ...
            "We apply sandwich ordering to every query regardless of type. A simple factual question ('what is HNSW?') might only need 1 chunk. A complex question ('compare HNSW and brute force') might need a different arrangement. We never differentiated by query type.",
        ...
        (
            ...
            "Our 5 documents sometimes describe the same concept differently — the RAG paper and Pinecone guide have different framings of retrieval. We pass both to the model with no conflict flag. A PM should audit: which concepts appear across multiple docs with potentially contradictory framings?",
        ...
        (
            ...
            "We defaulted to sandwich ordering because it's the documented best practice. We never validated it on our educational queries. A PM should require empirical validation: run sandwich vs descending vs ascending on 20 questions, measure faithfulness, then pick based on data.",
