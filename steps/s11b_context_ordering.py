...
def render():
    ...
    rows_data = [
        (
            ...
            "A legal RAG team placed the most relevant clause in the middle of a 6-chunk context window — the model consistently missed it in answers until ordering was changed to put it first.",
        ...
        (
            ...
            "Notion AI found their context assembly preserved retrieval rank order — the best chunk was sometimes ranked 3rd structurally, leading to answers that missed the most relevant fact entirely.",
        ...
        (
            ...
            "Glean found multi-hop reasoning queries benefited from descending relevance order while simple lookups did equally well with sandwich — they shipped query-type-aware ordering after testing.",
        ...
        (
            ...
            "A financial services RAG retrieved an outdated policy chunk alongside the current one — both were passed to the model with no conflict signal, and the model blended them into an answer that quoted the wrong policy.",
        ...
        (
            ...
            "A coding assistant RAG adopted sandwich ordering by default because it's the standard recommendation — but for their short, highly technical chunks the effect was negligible, and they kept it only because it caused no harm rather than because it was proven to help.",
